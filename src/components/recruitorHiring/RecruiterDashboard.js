                    ...
                    <nav class="navbar navbar-expand-md navbar-light p-0">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav w-100 ms-5">
                                ...
                                <li class="nav-item">
                                    <Link to="/recruiterdashboard" class="nav-link active">
                                        Dashboard
                                    </Link>
                                </li>
                                <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="mb-3">
                        <div class="card btn-gradient-121 widget-flat">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Profile Requested</h5>
                    ...
                    <div class="mb-3">
                        <div class="card widget-flat btn-gradient-success">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Profile Views</h5>
                    ...
                    <div class="mb-3">
                        <div class="card widget-flat btn-gradient-danger">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="text-muted fw-normal mt-0" title="Average Revenue">View Training Program</h5>
                    ...
                    <div class="mb-3">
                        <div class="card widget-flat btn-gradient-info">
                            ...
                            <div class="card-body">
                                <div class="float-end">
                                    <i class="mdi widget-icon ri-command-line"></i>
                                </div>
                                <h5 class="text-muted fw-normal mt-0" title="Growth">Profile Interview</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="card widget-flat">
                                <h4 class="graphtitles">Profile Requested</h4>
                                <div class="charthhe" id="chartContainer" style="height: 240px; width: 100%;"></div>
                            </div> 
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="card widget-flat">
                                <h4 class="graphtitles">Profile Views</h4>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card widget-flat">
                               <h4 class="graphtitles">Profile Interview</h4>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="card widget-flat btn-gradient-light">
                        <div class="bg-layerbg"><img src="../assets/images/circle.svg" alt="" /></div>
                        <div class="card-body">
                            <div class="float-end">
                                <i class="mdi widget-icon ri-user-unfollow-line"></i>
                            </div>
                            <h5 class="text-muted fw-normal mt-0" title="Growth">Candidates Rejected</h5>
                            <h3 class="mt-2 mb-0">784</h3>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                        ...
                        <div class="card widget-flat btn-gradient-dark">
                            <div class="bg-layerbg"><img src="../assets/images/circle.svg" alt="" /></div>
                            <div class="card-body">
                                <div class="float-end">
                                    <i class="mdi widget-icon ri-user-search-line"></i>
                                </div>
                                <h5 class="text-muted fw-normal mt-0" title="Growth">Hired Candidates/profiles</h5>
                                <h3 class="mt-2 mb-0">5000</h3>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="card widget-flat btn-gradient-primary">
                        <div class="bg-layerbg"><img src="../assets/images/circle.svg" alt="" /></div>
                        <div class="card-body">
                            <div class="float-end">
                                <i class="mdi widget-icon ri-shield-user-line"></i>
                            </div>
                            <h5 class="text-muted fw-normal mt-0" title="Growth">Candidates</h5>
                            <h3 class="mt-2 mb-0">10000</h3>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="card widget-flat btn-gradient-warning">
                        <div class="bg-layerbg"><img src="../assets/images/circle.svg" alt="" /></div>
                        <div class="card-body">
                            <div class="float-end">
                                <i class="mdi widget-icon flaticon-student"></i>
                            </div>
                            <h5 class="text-muted fw-normal mt-0" title="Growth">Students University</h5>
                            <h3 class="mt-2 mb-0">4578</h3>
